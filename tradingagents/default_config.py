...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    "data_vendors": {
        ...
        "technical_indicators": "akshare, yfinance",  # Options: alpha_vantage, yfinance, akshare
    ...
    # Can be comma-separated for fallback priority, e.g. "akshare, yfinance, alpha_vantage"
    "tool_vendors": {
